...
sub ABFALL_getEvents($) {
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 1, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 2, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 3, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 4, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 5, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 6, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 7, 19";
                # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        )
                        {
                            ...
                            )
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 8, 19";
                                # Trace <----
                            ...
                            else
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 9, 19";
                                # Trace <----
                        ...
                        else
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 10, 19";
                            # Trace <----
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 11, 19";
                            # Trace <----
                        ...
                        else
                        {
                            ...
                            )
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 12, 19";
                                # Trace <----
                            ...
                            else
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 13, 19";
                                # Trace <----
                ...
                else
                {
                    ...
                    )
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 14, 19";
                        # Trace <----
                    ...
                    else
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 15, 19";
                        # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 16, 19";
            # Trace <----
    ...
    else
    {
        ...
        )
        {
            ...
            if ($dayDiff < $foundItem->{days} && $eventDate > time)
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 17, 19";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 18, 19";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170905.142413, 19, 19";
            # Trace <----
