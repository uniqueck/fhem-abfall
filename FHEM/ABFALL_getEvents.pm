# $Id: ABFALL_getEvents.pm 11022 2017-12-29 23:49:48Z uniqueck $
...
sub ABFALL_getEvents($) {
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 1, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 2, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 3, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 4, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 5, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 6, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 7, 19";
                # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        )
                        {
                            ...
                            )
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 8, 19";
                                # Trace <----
                            ...
                            else
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 9, 19";
                                # Trace <----
                        ...
                        else
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 10, 19";
                            # Trace <----
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 11, 19";
                            # Trace <----
                        ...
                        else
                        {
                            ...
                            )
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 12, 19";
                                # Trace <----
                            ...
                            else
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 13, 19";
                                # Trace <----
                ...
                else
                {
                    ...
                    )
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 14, 19";
                        # Trace <----
                    ...
                    else
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 15, 19";
                        # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 16, 19";
            # Trace <----
    ...
    else
    {
        ...
        )
        {
            ...
            if ($dayDiff < $foundItem->{days} && $eventDate > time)
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 17, 19";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 18, 19";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20171229.234737, 19, 19";
            # Trace <----
