# $Id: ABFALL_getEvents.pm 11021 2017-09-13 00:32:22Z uniqueck $
...
sub ABFALL_getEvents($) {
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 1, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 2, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 3, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 4, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 5, 19";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 6, 19";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 7, 19";
                # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        )
                        {
                            ...
                            )
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 8, 19";
                                # Trace <----
                            ...
                            else
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 9, 19";
                                # Trace <----
                        ...
                        else
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 10, 19";
                            # Trace <----
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 11, 19";
                            # Trace <----
                        ...
                        else
                        {
                            ...
                            )
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 12, 19";
                                # Trace <----
                            ...
                            else
                            {
                                ...
                                # Trace ---->
                                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 13, 19";
                                # Trace <----
                ...
                else
                {
                    ...
                    )
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 14, 19";
                        # Trace <----
                    ...
                    else
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 15, 19";
                        # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 16, 19";
            # Trace <----
    ...
    else
    {
        ...
        foreach my $item (@terminliste ){
            ...
            my $actualText = $summarys[$startTimeIndex - 1];
            $actualText =~ s/\\,/,/g;
        ...
        )
        {
            ...
            if ($dayDiff < $foundItem->{days} && $eventDate > time)
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 17, 19";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 18, 19";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_getEvents($name) - ABFALL_getEvents, 20170912.220911, 19, 19";
            # Trace <----
