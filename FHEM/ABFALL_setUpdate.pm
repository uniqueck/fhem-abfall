...
sub ABFALL_setUpdate($) {
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 1, 21";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 2, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 3, 21";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 4, 21";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 5, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 6, 21";
            # Trace <----
        ...
        else
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 7, 21";
                # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 8, 21";
                        # Trace <----
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 9, 21";
                            # Trace <----
                        ...
                        else
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 10, 21";
                            # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 11, 21";
                    # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 12, 21";
                    # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 13, 21";
                    # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 14, 21";
                    # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 15, 21";
                    # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 16, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 17, 21";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 18, 21";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 19, 21";
            # Trace <----
    ...
    else
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 20, 21";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170907.233617, 21, 21";
            # Trace <----
