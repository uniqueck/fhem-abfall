...
sub ABFALL_setUpdate($) {
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 1, 21";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 2, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 3, 21";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 4, 21";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 5, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 6, 21";
            # Trace <----
        ...
        else
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 7, 21";
                # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 8, 21";
                        # Trace <----
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 9, 21";
                            # Trace <----
                        ...
                        else
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 10, 21";
                            # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 11, 21";
                    # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 12, 21";
                    # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 13, 21";
                    # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 14, 21";
                    # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 15, 21";
                    # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 16, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 17, 21";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 18, 21";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 19, 21";
            # Trace <----
    ...
    else
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 20, 21";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170905.000521, 21, 21";
            # Trace <----
