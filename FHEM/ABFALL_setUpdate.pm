...
sub ABFALL_setUpdate($) {
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 1, 21";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 2, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 3, 21";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 4, 21";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 5, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 6, 21";
            # Trace <----
        ...
        else
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 7, 21";
                # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 8, 21";
                        # Trace <----
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 9, 21";
                            # Trace <----
                        ...
                        else
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 10, 21";
                            # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 11, 21";
                    # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 12, 21";
                    # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 13, 21";
                    # Trace <----
            ...
            else
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 14, 21";
                    # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 15, 21";
                    # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 16, 21";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 17, 21";
                # Trace <----
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 18, 21";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 19, 21";
            # Trace <----
    ...
    else
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 20, 21";
            # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170904.113200, 21, 21";
            # Trace <----
