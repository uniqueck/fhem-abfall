...
sub ABFALL_setUpdate($) {
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 1, 20";
            # Trace <----
            ...
            # Action A04: readingsBeginUpdate
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 2, 20";
            # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 3, 20";
            # Trace <----
            
            # Action A06: next event
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 4, 20";
            # Trace <----
            
            # Action A05: readingsEndUpdate
    ...
    )
    {
        ...
        # Condition B06: event readingName is empty
        if (
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 5, 20";
            # Trace <----
            
            # Action A18: warn empty readingname
        ...
        else
        {
            ...
            # Condition B07: event days equals 0
            if (
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 6, 20";
                # Trace <----
                
                # Action A07: append as now
            ...
            else
            {
                ...
                # Condition B08: next days initialized
                if (
                $nextAbfall_tage > -1
                )
                {
                    
                    # Condition B09: event days < next days
                    if (
                    ...
                    )
                    {
                        ...
                        # Trace ---->
                        Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 7, 20";
                        # Trace <----
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 8, 20";
                            # Trace <----
                            
                            # Action A08: append next
                        ...
                        else
                        {
                            ...
                            # Trace ---->
                            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 9, 20";
                            # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 10, 20";
                    # Trace <----
    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 11, 20";
                    # Trace <----
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 12, 20";
                    # Trace <----
                    
                    # Action A17: initialize pickups used
            ...
            else
            {
                ...
                )
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 13, 20";
                    # Trace <----
                    
                    # Action A16: initialize pickups
                ...
                else
                {
                    ...
                    # Trace ---->
                    Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 14, 20";
                    # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 15, 20";
            # Trace <----
    ...
    )
    {
        ...
        # Condition B11: now days = 0
        if (
        $nowAbfall_tage == 0
        )
        {
            
            # Condition B12: last pickup <> actual pickup
            if (
            ...
            )
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 16, 20";
                # Trace <----
                
                # Action A11: set now reading
                ...
                # Action A12: increment last pickup
            ...
            else
            {
                ...
                # Trace ---->
                Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 17, 20";
                # Trace <----
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 18, 20";
            # Trace <----
    ...
    else
    {
        ...
        )
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 19, 20";
            # Trace <----
            
            # Action A13: set next reading
            ...
            # Action A14: set state next days
        ...
        else
        {
            ...
            # Trace ---->
            Log3 $name, 5, "ABFALL_setUpdate($name) - ABFALL_setUpdate, 20170903.234001, 20, 20";
            # Trace <----
            
            # Action A15: set state no pickups
